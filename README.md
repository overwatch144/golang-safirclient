...
## Installation
```bash
go get github.com/yourusername/golang-safirclient
```
...
### Safir Optimization
```go
import "github.com/yourusername/golang-safirclient/optimization"
...
### Safir Migration
```go
import "github.com/yourusername/golang-safirclient/migration"
...
### Safir Cloud Watcher
```go
import "github.com/yourusername/golang-safirclient/cloudwatcher"
